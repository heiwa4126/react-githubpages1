...
pnpm i
pnpm run dev
# http://localhost:5173/ をブラウザで確認
pnpm run build && pnpm run preview
# http://localhost:4173/ をブラウザで確認
```
...
で、[pages-pnpm.yml](.github/workflows/pages-pnpm.yml) ワークフローが動いて
GitHub Pages としてデプロイされる。
